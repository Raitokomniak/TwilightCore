...
public class PlayerShoot : MonoBehaviour {
	...
	public void InitShoot(){
		...
		transform.position = new Vector3 (GameController.gameControl.enemyLib.centerX, -8, 0);
	...
	void Update () {
		...
		&& coolDownTimer <= 0 
		&& !GameController.gameControl.gameEnd.gameOver 
		&& !GameController.gameControl.pause.paused
			&& !GameController.gameControl.dialog.handlingDialog){
			Shoot();
		}
	...
	void Shoot()
	{
		...
		GameController.gameControl.sound.PlaySound("Player", "Shoot", true);
	...
	public void UpdateShootLevel(){
		damage = GameController.gameControl.stats.damage;
		coolDown = GameController.gameControl.stats.shootSpeed;
		bulletScale = GameController.gameControl.stats.bulletScale;
		shootLevel = GameController.gameControl.stats.shootLevel;
