...
public class Stage2 : Stage
{
	...
	public override void InitWaves(float difficultyMultiplier) {
		...
		lib.NewWave (new Wave (3f, mp, p, 1, false, 0, false, 10f / difficultyMultiplier, 0), new ArrayList { lib.middleTop });
		...
		p.Customize("Delay", 1f);
		p.Customize("CoolDown", 1f);
		lib.NewWave (new Wave (5f, mp, p, 1, false, 0, false, 10f / difficultyMultiplier, 0), new ArrayList { lib.rightTop });
		...
		p.Customize("Delay", 1f);
		p.Customize("CoolDown", 1f);
		lib.NewWave (new Wave (7f, mp, p, 1, false, 0, false, 10f / difficultyMultiplier, 0), new ArrayList { lib.leftTop });
		...
		p.Customize ("BulletCount", Mathf.Ceil(4 * (difficultyMultiplier / 2)));
		p.SetSprite ("Circle", "Glow", "Red");	
		p.Customize(new BulletMovementPattern(false, "StopAndRotate", 5f, p, 0, 14));
		lib.NewWave (new Wave (27f, mp, p, 10, false, 0, false, 3f / difficultyMultiplier, 0), new ArrayList { lib.topRight });
		...
		lib.NewWave (new Wave (35f, mp, p, 10, false, 0, false, 3f / difficultyMultiplier, 0), new ArrayList { lib.topRight });
		...
		p.Customize (new BulletMovementPattern (false, "WaitToHome", 9f, p, 0, 14));
		p.SetSprite ("Arrow", "Glow", "Red");	
		lib.NewWave (new Wave (40f, mp, p, 2, false, 0, false, 3f / difficultyMultiplier, 0), new ArrayList { lib.topRight });
		...
		lib.NewWave (new Wave (43f, mp, p, 2, false, 0, false, 3f / difficultyMultiplier, 0), new ArrayList { lib.topLeft });

		Wave boss = new Wave(126f, null, null, 1,  false, 150, true, 3f, 2);
